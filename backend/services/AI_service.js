...
async function generateInterviewReport({resume, selfDescription, jobDescription}){
    ...
    const response=await ai.models.generateContent({
        ...
        config:{
            ...
            responseSchema:z.toJSONSchema(interviewReportSchema)//we want the response to follow the interviewReportSchema
        }
    })

    return JSON.parse(response.text)//parsing the response text to JSON and returning it
} 
